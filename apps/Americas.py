...
print(loc_data['iso_alpha'].unique())
...
#get European data
Ame_data =df2[df2['continent'] == "Americas"]
#get unique countries
country_names = Ame_data['country'].unique()
loc_cols=list(df2.columns)
#print(Ame_data['observation_time'])
#print(Ame_data)
Ame_data = Ame_data.drop_duplicates()
#print(Ame_data.isnull().sum())
#sys.exit()
...
layout = html.Div(style={'backgroundColor': colors['background']},children=[
    dbc.Container([
        dbc.Row([
            ...
            dbc.Col(html.H1("American Countries Weather",        
             style={
            'textAlign': 'center',
            'color': colors['text']}), 
            className="mb-5 mt-5")
...
@app.callback(
    ...
    Output(component_id='geochart3', component_property='figure'),
    Output(component_id='trendline3', component_property='figure')],
...
def update_graphs(selected_count,erangevalue,eyvar):
    ...
    d = Ame_data[(Ame_data['humidity'] >= erangevalue[0]) & (Ame_data['humidity'] <= erangevalue[1])]
    data =[]
