...
#get European data
Asia_data =df2[(df2['continent'] == "Asia") | (df2['continent'] == "Oceania")]
#get unique countries
country_names = Asia_data['country'].unique()
loc_cols=list(df2.columns)
#print(Asia_data['observation_time'])
#print(Asia_data)
Asia_data = Asia_data.drop_duplicates()
#print(Asia_data)
#sys.exit()
...
layout = html.Div(style={'backgroundColor': colors['background']},children=[
    dbc.Container([
        dbc.Row([
            ...
            dbc.Col(html.H1("Asia & Oceania Countries Weather",        
             style={
            'textAlign': 'center',
            'color': colors['text']}), 
            className="mb-5 mt-5")
...
@app.callback(
    ...
    Output(component_id='geochart1', component_property='figure'),
    Output(component_id='trendline1', component_property='figure')],
    [Input(component_id='country_dropdown', component_property='value'),
    Input(component_id='uv_range', component_property='value'),
...
def update_graphs(selected_count,erangevalue,eyvar):
    ...
    d = Asia_data[(Asia_data['uv_index'] >= erangevalue[0]) & (Asia_data['uv_index'] <= erangevalue[1])]
    data =[]
